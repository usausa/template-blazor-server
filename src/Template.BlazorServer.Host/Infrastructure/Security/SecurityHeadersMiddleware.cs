namespace Template.BlazorServer.Host.Infrastructure.Security;

using Template.BlazorServer.Host.Settings;
...
public sealed class SecurityHeadersMiddleware
{
    ...
    private Task OnStarting(object state)
    {
        ...
        // The nonce admits the import map that Blazor renders inline. MudBlazor needs inline styles.
