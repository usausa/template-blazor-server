namespace Template.BlazorServer.Infrastructure.Circuits;
...
public sealed class CircuitTrackerTests
{
    ...
    public void AddAndRemoveChangeCount()
    {
        ...
        // Act
        tracker.Add(new CircuitInfo("a", "admin", Now, true));
        tracker.Add(new CircuitInfo("b", null, Now.AddSeconds(1), true));
        tracker.Remove("a");
        tracker.Remove("x");
